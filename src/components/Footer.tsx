      ...
      <div className="section-container px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="border-t border-white/[0.06] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-surface-500">
            &copy; 2026 ELAV8 Builds. All rights reserved.
          </p>

          {/* Social links */}
          <div className="flex items-center gap-5">
            <a href="#" className="text-surface-500 hover:text-white transition-colors" aria-label="Twitter / X">
            ...
            <a href="#" className="text-surface-500 hover:text-white transition-colors" aria-label="GitHub">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
